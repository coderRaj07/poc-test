...
// // Only the score and metadata will be written onchain, the rest of the proof lives offchain.
...
// const proofResponseSchema = new Schema({
//     dlp_id: { type: Number, required: true },
//     valid: { type: Boolean, default: false },
//     score: { type: Number, default: 0.0 },
//     authenticity: { type: Number, default: 0.0 },
//     ownership: { type: Number, default: 0.0 },
...
// const ProofResponse = model('ProofResponse', proofResponseSchema);
